...
# @File Path: /home/whutddk/下载/HWCC2019/SDK/CodeCraft-2019/src/ol_scheduler.py
# @Author: Ruige_Lee
# @Date:   2019-03-25 08:50:11
# @Last Modified by:   whutddkUbuntu16
# @Last Modified time: 2019-03-30 09:47:14
	...
	def fin_scheduler(self,preAnswer):
		...
		for ans in range(0,len(answer)):
			if ( additionalTime < takeoffset ):
				pass
			elif ( answer[ans][1] < (additionalTime-takeoffset)//27 ):
				answer[ans][1] = (additionalTime-takeoffset)//27
			else:
				pass
